...
class CenarioequipeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $this->log->setLog('Novo_ADA', 'Usuário acessou a aba Cenário Equipes');
        ...
        // $log->operacao = "Usuario acessou o módulo Cenário Equipes.";
        // $log->save();        

        //Log::info($query->toSQL(), $query->getBindings());
        $busca_cenario = $query->get();
        $compet_format = $this->formatarCompetencia($this->competencias);
        ...
        return view('cenario', [
            ...
            'competencias_selec' => $compet_selec,
            'competencias_format' => $this->competencias_format,
    ...
    public function showProfissionais($equipe, $competencia)
    {
        ...
        $this->log->setLog('Novo_ADA','O Usuario Acessou a aba e viu Relação de Profissionais e Profissionais pro CBO ');
    ...
    public function listaProfissionais(Request $request)
    {
        ...
        $this->log->setLog('Novo_ADA','Usuario entrou na Aba Profissionais');
        $max_compet = '';
