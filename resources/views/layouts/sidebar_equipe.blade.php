...
<body>
    <header class="header d-flex" style="position: sticky; top: 0;">
        ...
        <div class="mx-auto my-auto text-center">
            <img src="{{ asset('img/img-equipes.png') }}" class="img-fluid rounded-top" id="logoada" alt="ADA" />
        </div>
    </header>
    <div class="d-flex">
        <div class="sidebar text-white p-3" id="sidebar">
            ...
            <nav class="nav flex-col menu">
                ...
                <a class="nav-link text-white show-spinner" href="/cenario"><i class="bi bi-people-fill"></i><span>Cenário de
                        Equipes</span></a>
